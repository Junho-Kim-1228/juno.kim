...
export function ProjectsPage() {
  ...
  return (
    <section className="page-section">
      <div className="section-heading"><div><p className="eyebrow">PORTFOLIO</p><h1>프로젝트</h1></div>{user && <Link className="button-link small" to="/projects/new">프로젝트 추가</Link>}</div>
