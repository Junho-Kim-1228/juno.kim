...
export function GamesPage() {
  return <section className="games-page page-section">
    ...
    <div className="game-list">
      <Link className="game-card" to="/games/aim"><span className="game-card-mark">◎</span><span><strong>숫자 빨리 누르기</strong><small>1부터 20까지 빠르게 누르세요.</small></span><span className="game-card-arrow">→</span></Link>
